...
class Sampling:
    ...
    def run_sampling (self):
        ...
        if self.dlg.ui.lineEditInRast.text() == '':
            msg = QMessageBox()
            msg.setIcon(QMessageBox.Information)
            msg.setText("Input: Undefined rasters path")
            msg.setWindowTitle("Info")
            msg.exec_() 
            return 0 
        
        elif self.dlg.ui.lineEditVec.text() == '':
            msg = QMessageBox()
            msg.setIcon(QMessageBox.Information)
            msg.setText("Input: Undefined vectors path")
            msg.setWindowTitle("Info")
            msg.exec_() 
            return 0 
        else:
            ...
            if stats==[]:
                msg = QMessageBox()
                msg.setIcon(QMessageBox.Information)
                msg.setText("Parameters: Select statistics")
                msg.setWindowTitle("Info")
                msg.exec_() 
                return 0 
            #Set lineEdit Out
            ...
            #Assess path
            if os.path.exists(rasters_path)==False or os.path.exists(vectors_path)==False:
                    msg = QMessageBox()
                    msg.setIcon(QMessageBox.Information)
                    msg.setText("There isn't: "+rasters_path + ' or '+vectors_path )
                    msg.setWindowTitle("Info")
                    msg.exec_() 
                    return 0
            else:
            ...
            if rasters_files == []:
                msg = QMessageBox()
                msg.setIcon(QMessageBox.Information)
                msg.setText("Input: There isn't rasters (Rasters path: .tif or .tiff)")
                msg.setWindowTitle("Info")
                msg.exec_() 
                return 0 
            elif vectors_files == []:
                msg = QMessageBox()
                msg.setIcon(QMessageBox.Information)
                msg.setText("Input: There isn't vectors (Vectors path: .shp)")
                msg.setWindowTitle("Info")
                msg.exec_() 
                return 0 

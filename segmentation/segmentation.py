...
class Segmentation:
    ...
    def run(self):
        ...
        self.dlg.ui.comboBoxBounding.clear()
    ...
    def run_segmentation(self):
        ...
        if self.dlg.ui.comboBoxRaster.currentText() == 'None':
            ...
            not os.path.exists(paths):
                ...
                path_segs=paths+os.path.sep+'Segs'                 
                #Goods
                path_goods= paths+os.path.sep+'Goods'                   
                #SHP
                path_shps=paths+os.path.sep+'SHP'
                ...
                os.path.exists(path_shps):
                    msg = QMessageBox()
                    msg.setIcon(QMessageBox.Information)
                    msg.setText("Output: A folder already exists (Segs, Goods or SHP) ")
                    msg.setWindowTitle("Info")
                    msg.exec_() 
                    return 0  

...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 535, 327))
        ...
        self.gridLayout_3.addWidget(self.labelAmountMem, 7, 0, 1, 3)
        ...
        self.labelSeeds = QtWidgets.QLabel(self.scrollAreaWidgetContents)
        self.labelSeeds.setObjectName("labelSeeds")
        self.gridLayout_3.addWidget(self.labelSeeds, 11, 0, 1, 6)
        ...
        self.gridLayout_3.addWidget(self.spinBoxMiter, 9, 3, 1, 3)
        ...
        self.comboBoxBounding = QtWidgets.QComboBox(self.scrollAreaWidgetContents)
        self.comboBoxBounding.setObjectName("comboBoxBounding")
        self.gridLayout_3.addWidget(self.comboBoxBounding, 14, 0, 1, 6)
        self.labelBounding = QtWidgets.QLabel(self.scrollAreaWidgetContents)
        self.labelBounding.setObjectName("labelBounding")
        self.gridLayout_3.addWidget(self.labelBounding, 13, 0, 1, 6)
        ...
        self.comboBoxSeeds = QtWidgets.QComboBox(self.scrollAreaWidgetContents)
        self.comboBoxSeeds.setObjectName("comboBoxSeeds")
        self.gridLayout_3.addWidget(self.comboBoxSeeds, 12, 0, 1, 6)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.labelSeeds.setText(_translate("Dialog", "Input raster map with starting seeds [optional]"))
        self.labelMaxCells.setText(_translate("Dialog", "Minimum Object Size (pixels)"))
        self.labelEndMinCel.setText(_translate("Dialog", "end"))
        self.labelStartMinCel.setText(_translate("Dialog", "Start"))
        self.labelBounding.setText(_translate("Dialog", "Input bounding/constraining raster map [optional]"))
        ...
        self.labelPathSegs.setText(_translate("Dialog", "Segmentations path"))
